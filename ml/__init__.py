...
from ml.surnamer import Nation
from ml.toxificator import Toxic
from ml.hofstedefier import Hofstede
import spacy
...
class Predictor:
    ...
    def predict(self, raw, obj: dict = None):
        answer, cleaned = self.preprocessor.preprocess(raw)

        answer["toxic"] = self.toxic.predict(cleaned)
